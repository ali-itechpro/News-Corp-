            ...
            collectionDetails.forEach(item => {
                if(items.collectionid==item.id){
                    ...
                    if(item.id == 1001 ){
                        ...
                        <br><br>
                        <div class="read-time text-timer"><span class="oi oi-clock"> 2m &nbsp;</span> <span class="oi oi-comment-square"></span></div>`
                    ...
                    //sub news
                        ...
                        <h2 class="title"><span class="oi oi-plus text-danger icon-title"></span>${item.Title}</h2>
                        <div>${item.Intro}</div>
                        <div class="text-timer"><span class="oi oi-clock"></span> 1h &nbsp; <span class="oi oi-comment-square"></span>  1</div>
                        <hr class="mt-4 mb-4">`
                    ...
                    <br/><br/>
                    <div class="text-timer"><span class="oi oi-clock"></span>  1h</div>
                    <hr class="mt-2 mb-2">
                    </div> `;
                    }
